        ...
        <motion.div
            ...
            <div className="feedback-section-timer-wrap">
                <div className="feedback-section-timer-app">
                    ...
                    <p className='feedback-section-timer-description'>Күн</p>
                </div>
                <div className="feedback-section-timer-app">
                    <p className='feedback-section-timer'>{time.h}</p>
                    <p className='feedback-section-timer-description'>Саат</p>
                </div>
                <div className="feedback-section-timer-app">
                    <p className='feedback-section-timer'>{time.m}</p>
                    <p className='feedback-section-timer-description'>Мүнөт</p>
                </div>
                <div className="feedback-section-timer-app">
